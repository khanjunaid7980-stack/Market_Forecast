...
def sensitivity_heatmap(grid: pd.DataFrame, current_price: float | None = None) -> go.Figure:
    ...
    fig = go.Figure(data=go.Heatmap(
        z=z, x=grid.columns.astype(str), y=grid.index.astype(str),
        colorscale="RdYlGn", colorbar=dict(title="Fair Value / share"),
...
__all__ = ["revenue_and_margins", "roic_vs_wacc", "ebit_to_market_cap", "cash_flow_breakdown", "leverage_and_liquidity", "dcf_projection_chart", "price_history_chart", "sensitivity_heatmap"]
