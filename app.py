...
with tab_ratios:
    ...
    st.caption("Liquidity · Solvency · Profitability · Efficiency · Valuation · Growth · Cash Flow Quality.")
...
**Moat adjustment:** a high moat (≥8) pulls a "Short" rating toward zero.
A low moat (≤3) pulls a "Buy" rating toward zero.
